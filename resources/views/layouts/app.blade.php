    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">Mérkőzések</a>
                <a class="navbar-brand" href="{{ url('/') }}">Csapatok</a>
                <a class="navbar-brand" href="{{ url('/') }}">Tabella</a>
                <a class="navbar-brand" href="{{ url('/') }}">Kedvenceim</a>
